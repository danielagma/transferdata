**QA Execution: PASSED ✅ (Part 1)**

* **Environment:** DEV2

**Execution Summary:**
The Iceberg orders (Show Qty) functionality has been successfully validated. The UI correctly handles the display, dynamic locking of fields, MULTI venue restrictions, and all mathematical boundary rules for quantity inputs as defined in the Acceptance Criteria.
