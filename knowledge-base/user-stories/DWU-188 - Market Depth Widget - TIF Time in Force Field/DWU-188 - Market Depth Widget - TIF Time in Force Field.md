...
| Suggested automation order | **Tier 4** — Market Depth order-entry field; no dependency on the Ladder quantity bar. Can be automated in parallel with [[DWU-163]] / [[DWU-189]]. |
